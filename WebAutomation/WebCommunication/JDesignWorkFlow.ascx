<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDesignWorkFlow.ascx.cs" Inherits="WebAutomation.WebCommunication.JDesignWorkFlow" %>
<%--<link href="WebAutomation/temp2/font-awesome.css" rel="stylesheet">--%>
<link href="Style/jsplumb.css" rel="stylesheet">
<link href="Style/statemachine.css" rel="stylesheet">

<div class="FormContent unselectable">
	<div id="dv_title" class="BigTitle"></div>
    <div id="dv_condition_help" class="hidden">
        <div style="height: 30px;"> 
        <a href='#' class="a_close" onclick="HideConditionHelp()">×</a>    
        </div>

    </div>
    <div id="dv_properties">
        <div style="height: 30px;"> 
        <a href='#' class="a_close" onclick="ResetAndHideProperties()">×</a>    
        </div>
        <div id="dv_basic_properties" class="rfloat-half">
            <table>
                <tr>
                    <td style="width:25%">
                        <label>نام</label>
                    ...
                    <td>  
                        <input id="txtName" type="text" value="جدید"/>  
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>  
                        <select id="cmbTypes" onchange="ShowPropertiesControls(parseInt(this.value))">
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>  
                        <select id="cmbConditions">
                        </select>
                        <input id="btnAddCondition" type="button" value="+"  onclick="btnAddCondition_click()"/>
                    </td>
                </tr>
                <tr>
                    <td class="align-top">
                    ...
                    <td>  
                        <textarea id="txtCondition" onfocus="txtFocus=this;"></textarea>
                        <input id="btnConditionHelp" type="button" value="?" onclick="btnConditionHelp_click()"/>
                    </td>
                </tr>  
            </table>
        </div>
        <div id="dv_posts" class="hidden rfloat-half">
            <table>
                <tr>
                ...
                <tr>
                    <td class="align-top">
                        <label id="lbl_posts">پست ها</label>
                    </td>
                    <td>
                        <textarea id="txtPostCodes"></textarea>   
                        <textarea id="txtPostsSQL" onfocus="txtFocus=this;"></textarea>    
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input id="btnAddPostCode" type="button" value="افزودن" onclick="btnAddPostCode_click()"/>    
                    </td>
                </tr>
            </table>
        </div>
        <input id="btnSaveProperties" type="button" value="تایید" onclick="btnSaveProperties_click()"/>
    </div>
    <div id="dv_temp">   
        <div class="w unselectable" id="temp">جدید
            <div class="ep"></div>
        </div>
    </div>
    <div style="display:none;z-index: 101;" id="contextMenu">
        <table  border="0" cellpadding="0" cellspacing="0" 
            style="border: thin solid #808080; cursor: default; width: 90px; background-color:white;">
            <tr>
                <td >
                <div  class="ContextItem">ویرایش جزئیات</div>
                </td>
            </tr>
            <tr>
                <td >
                    <div  class="ContextItem">حذف</div>
                </td>
            </tr>
        </table>
        </div>
    <div id="main">
<div class="statemachine dv_nodes" id="dv_nodes" oncontextmenu="return false" onmousedown="HideMenu('contextMenu');" onmouseup="HideMenu('contextMenu');">
</div>
    <input id="btnSave" type="button" value="ذخیره" onclick="btnSave_click()" />	
    </div>
...
<%--<script src="WebAutomation/temp2/demo-list.js"></script>--%>
