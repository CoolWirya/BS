...
namespace WebBaseNet.ScheduleService 
{
    public class JScheduleService : JSystem  
    {
        ...
        public int CodeBaseNet { get; set; }
        public int TypeService { get; set; }
        public bool IsActive { get; set; }
    
        public JScheduleService()
        {
        }
        public JScheduleService(int pCode)
        {
            if (pCode > 0)
                this.GetData(pCode);
        }
        ...
        public int Insert(JDataBase db = null)
        {
            ...
            jHistory.Save("WebBaseNet.JScheduleService", Code, 0, 0, 0, "ثبت زمانبندی نت اتوبوس", "", 0);
            return Code;
        }
    ...
    public class JScheduleServices
    {
