<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusNetStateReportControl.ascx.cs" Inherits="WebBusManagement.FormsBaseNet.JBusNetStateReportControl" %>
...
<div class="BigTitle">گزارش وضعیت نت اتوبوس ها</div>
