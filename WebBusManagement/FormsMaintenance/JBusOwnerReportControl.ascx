<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusOwnerReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusOwnerReportControl" %>
...
<div class="BigTitle">گزارش مالکین اتوبوس ها</div>
