<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSendDataReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusSendDataReportControl" %>
...
<div class="BigTitle">گزارش ارسال اطلاعات اتوبوس ها</div>
