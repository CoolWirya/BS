...
namespace WebBusManagement.FormsMaintenance
{
    public partial class JBusUsedSimCardChargeReport : System.Web.UI.UserControl
    {
        ...
        public void GetReport(DateTime? StartEventDate = null, DateTime? EndEventDate = null, int BusCode = 0)
        {
            ...
            {
                WhereStrAnd += @" and aal.EventDate between '" + StartEventDate.Value.Date.ToShortDateString() + " 00:00:00' and '" + EndEventDate.Value.Date.ToShortDateString() + " 23:59:59' ";
                if (BusCode > 0)
                    WhereStrAnd += " and aal.BusCode=" + BusCode;
            }

           WebControllers.MainControls.Grid.JGridView jGridView = RadGridReport; //("WebBusMaintenance_JBusUsedSimCardChargeReport");
           jGridView.ClassName = "WebBusManagement_FormsMaintenance_JBusUsedSimCardChargeReport"+BusCode.ToString()+"_"+(StartEventDate != null ? StartEventDate.Value.ToShortDateString() : "")+"_"+ (EndEventDate != null ? EndEventDate.Value.ToShortDateString() : "");
