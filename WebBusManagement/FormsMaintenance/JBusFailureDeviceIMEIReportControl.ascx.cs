...
namespace WebBusManagement.FormsMaintenance
{
    public partial class JBusFailureDeviceIMEIReportControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport(DateTime? StartEventDate = null, DateTime? EndEventDate = null)
        {
            ...
            WebControllers.MainControls.Grid.JGridView jGridView = RadGridReport; //("WebBusMaintenance_JBusFailureDeviceIMEIReport");
            jGridView.ClassName = "WebBusManagement_FormsMaintenance_JBusFailureDeviceIMEIReport" + (StartEventDate != null ? StartEventDate.Value.ToShortDateString() : "") + "_" + (EndEventDate != null ? EndEventDate.Value.ToShortDateString() : "");
