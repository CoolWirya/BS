<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JInvalidLinePriceReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JInvalidLinePriceReportControl" %>
...
<div class="BigTitle">گزارش مبالغ نادرست</div>
