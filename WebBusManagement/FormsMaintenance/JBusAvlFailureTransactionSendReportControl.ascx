<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusAvlFailureTransactionSendReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusAvlFailureTransactionSendReportControl" %>
...
<div class="BigTitle">گزارش عدم ارسال تراکنش AVL</div>
