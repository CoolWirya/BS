...
namespace WebBusManagement.FormsMaintenance
{
    public partial class JBusLastDataReportControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport()
        {
           ...
           WebControllers.MainControls.Grid.JGridView jGridView = RadGridReport; //("WebBusMaintenance_JBusLastDataReport");
           jGridView.ClassName = "WebBusManagement_FormsMaintenance_JBusLastDataReport";
