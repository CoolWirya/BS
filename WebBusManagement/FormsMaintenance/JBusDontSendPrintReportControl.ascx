<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusDontSendPrintReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusDontSendPrintReportControl" %>
...
<div class="BigTitle">گزارش اتوبوس هایی که پرینت خود را اعلام نکرده اند</div>
