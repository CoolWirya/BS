...
namespace WebBusManagement.FormsMaintenance
{
    public partial class JConsulHistoryReportControl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                LoadBus();
                ((WebControllers.MainControls.Date.JDateControl)txtFromDate).SetDate(DateTime.Now.AddYears(-2));
        ...
        public void GetReport(Int64 IMEI = 0, double BusNumebr = 0, DateTime? StartEventDate = null, DateTime? EndEventDate = null)
        {
            ...
            if (StartEventDate.HasValue && StartEventDate.Value.Date > NullDatetime)
            {
                ...
                WhereStr += @" and at.[Date] between '" + StartDTime.ToShortDateString() + " 00:00:00' and '" + EndDTime.ToShortDateString() + " 23:59:59'";
            }

            WebControllers.MainControls.Grid.JGridView jGridView = RadGridReport; //("WebBusMaintenance_JConsulHistory");
            jGridView.ClassName = "WebBusManagement_FormsMaintenance_JConsulHistory" + IMEI.ToString() + "_" + BusNumebr.ToString() + "_" + (StartEventDate != null ? StartEventDate.Value.ToShortDateString() : "") + "_" + (EndEventDate != null ? EndEventDate.Value.ToShortDateString() : "");
            jGridView.SQL = @"SELECT top 100 percent at.Code,at.IMEI,at.[Date],at.BusSerial,
                                ...
                                cast(cast(substring(at.[Version],3,1) AS INT)AS NVARCHAR)ConsulVersion
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtIMEI.Text != "" && txtIMEI.Text.Length == 15)
            {
                if (Int64.TryParse(txtIMEI.Text, out CuIMEI) == true)
                {
                    GetReport(Convert.ToInt64(txtIMEI.Text), 0,
