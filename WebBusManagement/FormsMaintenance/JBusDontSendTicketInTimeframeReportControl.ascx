<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusDontSendTicketInTimeframeReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusDontSendTicketInTimeframeReportControl" %>
...
<div class="BigTitle">گزارش عدم ارسال بلیط اتوبوس در بازه زمانی</div>
