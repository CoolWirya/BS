<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusFailureIMEIReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusFailureIMEIReportControl" %>
...
<div class="BigTitle">گزارش IMEI های نامعتبر</div>
