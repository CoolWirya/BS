<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusFailureDoorsReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusFailureDoorsReportControl" %>
...
<div class="BigTitle">گزارش عدم ارسال تراکنش دو درب</div>
