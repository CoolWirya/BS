<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JComparisonTicketTableAndExtractTableReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JComparisonTicketTableAndExtractTableReportControl" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<%@ Register Assembly="WebControllers" Namespace="WebControllers.MainControls.Grid" TagPrefix="cc1" %>

<div class="BigTitle">گزارش مقایسه جدول بلیط با جدول اکسترکت</div>
