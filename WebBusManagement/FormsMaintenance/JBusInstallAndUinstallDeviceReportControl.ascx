<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusInstallAndUinstallDeviceReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusInstallAndUinstallDeviceReportControl" %>
...
<div class="BigTitle">گزارش نصب و فک دستگاه ها</div>
