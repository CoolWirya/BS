...
{
    public partial class JBusQuerySendUpdateControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport(int BusCode = 0)
        {
            ...
            jGridView.ClassName = "WebBusManagement_FormsMaintenance_JBusQuerySendUpdateControl_" + BusCode.ToString();
...
// group by QueryCode"
            ...
            jGridView.Title = "JBusQuerySendUpdateControl";
            jGridView.Bind();
