<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusStatusMonthlyReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusStatusMonthlyReportControl" %>
...
<div class="BigTitle">گزارش وضعیت ماهانه اتوبوس</div>
