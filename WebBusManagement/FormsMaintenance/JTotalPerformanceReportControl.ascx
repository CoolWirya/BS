<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JTotalPerformanceReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JTotalPerformanceReportControl" %>
...
<div class="BigTitle">گزارش خلاصه وضعیت کارکرد</div>
