<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JConsulHistoryReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JConsulHistoryReportControl" %>
