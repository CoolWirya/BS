<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusStatisticalReportControl.ascx.cs" Inherits="WebBusManagement.FormsStatisticalReports.JBusStatisticalReportControl" %>
