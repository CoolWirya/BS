<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JMultiYearMonthsStatisticalReportControl.ascx.cs" Inherits="WebBusManagement.FormsStatisticalReports.JMultiYearMonthsStatisticalReportControl" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<div class="BigTitle">گزارش آماری مقایسه تراکنش و درآمد در ماه های سال های مختلف</div>
