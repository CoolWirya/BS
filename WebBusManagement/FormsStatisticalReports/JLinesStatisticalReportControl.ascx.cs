...
namespace WebBusManagement.FormsStatisticalReports
{
    public partial class JLinesStatisticalReportControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport(int ZoneCode = 0, int LineNumber = 0, int DayType = 0, DateTime? StartEventDate = null, DateTime? EndEventDate = null, int CardType = -1)
        {
            DataTable DtReport = WebClassLibrary.JWebDataBase.GetDataTable(BusManagment.Line.JLines.GetWebReportQuery(ZoneCode, LineNumber, DayType, StartEventDate, EndEventDate, CardType));
            ...
            if (DtReport != null)
            {
                ...
                RadHtmlChartCOL.PlotArea.XAxis.TitleAppearance.Text = "خطوط";
                ...
                RadHtmlChartCOL.PlotArea.XAxis.DataLabelsField = "LineNumber";
                ...
                RadHtmlChartPIE.PlotArea.XAxis.TitleAppearance.Text = "خطوط";
                ...
                for (int i = 0; i < DtReport.Rows.Count; i++)
                {
                    if (i == 0)
                        ...
                        Explode = false;
                    PI = new Telerik.Web.UI.PieSeriesItem(Convert.ToDecimal(DtReport.Rows[i]["TransactionCount"].ToString()), GetColor(i), DtReport.Rows[i]["LineNumber"].ToString(), Explode, true, true);
                ...
                RadHtmlChartCOLIncome.PlotArea.XAxis.TitleAppearance.Text = "خطوط";
                ...
                RadHtmlChartCOLIncome.PlotArea.XAxis.DataLabelsField = "LineNumber";
                ...
                RadHtmlChartPIEIncome.PlotArea.XAxis.TitleAppearance.Text = "خطوط";
                ...
                for (int i = 0; i < DtReport.Rows.Count; i++)
                {
                    if (i == 0)
                        ...
                        Explode = false;
                    PIIncome = new Telerik.Web.UI.PieSeriesItem(Convert.ToDecimal(DtReport.Rows[i]["InCome"].ToString()), GetColor(i), DtReport.Rows[i]["LineNumber"].ToString(), ExplodeIncome, true, true);
