<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JTicketTransactionStatisticalReportControl.ascx.cs" Inherits="WebBusManagement.FormsStatisticalReports.JTicketTransactionStatisticalReportControl" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<%@ Register Src="~/WebControllers/MainControls/Date/JDateControl.ascx" TagPrefix="uc1" TagName="JDateControl" %>

<div class="BigTitle">گزارش آماری تعداد تراکنش های بلیط</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">بازه زمانی:</td>
        <td style="direction: ltr">
            <span>دقیقه</span>
            <telerik:RadTextBox runat="server" ID="txtTimeInterval" Width="40px" MaxLength="2" EmptyMessage="دقیقه" Text="20"></telerik:RadTextBox>
            <asp:RangeValidator ID="RangeValidator8" runat="server" ErrorMessage="00 تا 60" ControlToValidate="txtTimeInterval" MinimumValue="00"
                MaximumValue="59" ValidationGroup="Report" Display="Dynamic" Type="Integer"></asp:RangeValidator>
        </td>
    </tr>
</table>
