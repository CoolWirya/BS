<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusServicesBusStatisticalReportControl.ascx.cs" Inherits="WebBusManagement.FormsStatisticalReports.JBusServicesBusStatisticalReportControl" %>
...
<div class="BigTitle">گزارش آماری سرویس های اتوبوس ها بر اساس اتوبوس در بازه زمانی</div>
