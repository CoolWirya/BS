<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JYearStatisticalReportControl.ascx.cs" Inherits="WebBusManagement.FormsStatisticalReports.JYearStatisticalReportControl" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<div class="BigTitle">گزارش آماری مقایسه سال های مختلف</div>
