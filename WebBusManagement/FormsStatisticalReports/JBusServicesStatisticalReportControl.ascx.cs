...
{
    public partial class JBusServicesStatisticalReportControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport(DateTime? StartEventDate = null, DateTime? EndEventDate = null)
        {
            ...
            DataTable DtReport = WebClassLibrary.JWebDataBase.GetDataTable(@"SELECT [Date] DateEventDate
                                                                                      ,count(*) TransactionCount
                                                                                  FROM [AutBusServices] a where 
