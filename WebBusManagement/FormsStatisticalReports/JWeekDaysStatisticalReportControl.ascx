<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JWeekDaysStatisticalReportControl.ascx.cs" Inherits="WebBusManagement.FormsStatisticalReports.JWeekDaysStatisticalReportControl" %>
