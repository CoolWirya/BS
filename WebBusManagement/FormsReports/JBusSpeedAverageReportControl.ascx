<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSpeedAverageReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusSpeedAverageReportControl" %>
...
<div class="BigTitle">گزارش متوسط سرعت اتوبوس ها</div>
...
<table style="width: 100%; height: auto; margin-top: 1px">
    <tr>
