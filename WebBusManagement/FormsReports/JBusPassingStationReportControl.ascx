<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusPassingStationReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusPassingStationReportControl" %>
...
<div class="BigTitle">گزارش عبور از ایستگاه اتوبوس ها</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowC">
        ...
        <td>
            <telerik:RadComboBox runat="server" ID="cmbStationType" Width="100%">
                <Items>
                    <telerik:RadComboBoxItem Text="همه" Value="0"/>
                    <telerik:RadComboBoxItem Text="ابتدا و انتها" Value="1"/>
                </Items>
            </telerik:RadComboBox>
        </td>
    </tr>
