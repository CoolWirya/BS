<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusServiceWithoutTransactionReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusServiceWithoutTransactionReportControl" %>
...
<div class="BigTitle">گزارش اتوبوس های با سرویس بدون تراکنش </div>
<table style="width: 500px">
    ...
    <tr class="Table_RowC">
     ...
     <tr class="Table_RowC">
        ...
        <td>
            <telerik:RadTextBox runat="server" ID="txtMaxTransaction" Width="100%" AutoPostBack="false" Text="0" InputType="Number"></telerik:RadTextBox>
        </td>
    </tr>
    </table>
