<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBazrasServiceReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBazrasServiceReportControl" %>
...
<div class="BigTitle">گزارش سرویس بازرس</div>
