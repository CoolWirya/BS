<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JNumOfPerformanceDayReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JNumOfPerformanceDayReportControl" %>
...
<div class="BigTitle">گزارش تعداد روزهای کارکرد اتوبوس ها</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowB">
     ...
     <tr class="Table_RowC">
        <td style="width: 150px">بهره بردار:</td>
        <td>
