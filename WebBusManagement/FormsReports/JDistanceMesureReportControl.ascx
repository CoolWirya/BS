<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDistanceMesureReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JDistanceMesureReportControl" %>
...
<div class="BigTitle">گزارش مسافت های طی شده</div>
