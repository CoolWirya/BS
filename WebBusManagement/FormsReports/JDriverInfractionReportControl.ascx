<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDriverInfractionReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JDriverInfractionReportControl" %>
...
<div class="BigTitle">گزارش تخلفات راننده</div>
<table style="width: 1000px"><tr>
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">رویداد:</td>
        <td>
            <telerik:RadComboBox runat="server" ID="cmbRule" Width="100%" Filter="Contains">
            </telerik:RadComboBox>
        </td>
    </tr>
    <tr class="Table_RowB">
    ...
    <tr class="Table_RowB">
        ...
        <td>
            ...
            <telerik:RadTextBox runat="server" id="txtHourOf" InputType="Number" Text="00" Width="40px" />
        </td>
    </tr>
    <tr class="Table_RowC">
        <td style="width: 150px">تا ساعت:</td>
        <td>
            <telerik:RadTextBox runat="server" id="txtMinuteTo" InputType="Number" Text="59" Width="40px"/>:
