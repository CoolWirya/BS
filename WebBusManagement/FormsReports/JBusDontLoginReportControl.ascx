<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusDontLoginReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusDontLoginReportControl" %>
...
<div class="BigTitle">گزارش اتوبوس هایی که لاگین نکرده اند</div>
