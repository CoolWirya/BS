<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JTransactionsDetailsReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JTransactionsDetailsReportControl" %>
...
<table style="width: 500px">
    <tr id="trBus" runat="server" visible="false" class="Table_RowB">
