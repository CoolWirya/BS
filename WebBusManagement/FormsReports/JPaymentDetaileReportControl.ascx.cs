...
{
    public partial class JPaymentDetaileReportControl : System.Web.UI.UserControl
    {
        ...
        {
            WebControllers.MainControls.Grid.JGridView jGridView = RadGridReport; //("WebBusReports_JPaymentDetaileReportControl");
            jGridView.ClassName = "WebBusReports_JBusReports_GetReport_JPaymentDetaileReportControl" + OwnerCode.ToString() + "_" + BusNumebr.ToString() + "_" + (StartEventDate != null ? StartEventDate.Value.ToShortDateString() : "") + "_" + (EndEventDate != null ? EndEventDate.Value.ToShortDateString() : "");
            jGridView.SQL = BusManagment.Documents.JAUTDocumentReport.GetDocumentDetaileWebQuery(OwnerCode, BusNumebr, StartEventDate, EndEventDate);
            jGridView.SQLType = (int)WebControllers.MainControls.Grid.SQLTypeEnum.Query;
            jGridView.PageSize = 50;
            jGridView.HiddenColumns = "Code";
            jGridView.Title = "JPaymentDetaileReportControl";
