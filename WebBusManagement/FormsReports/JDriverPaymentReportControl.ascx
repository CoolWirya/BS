<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDriverPaymentReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JDriverPaymentReportControl" %>
...
<div class="BigTitle">گزارش مالی راننده</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">شماره سند:</td>
        <td>
            <telerik:RadComboBox runat="server" ID="cmbDocumentCode" Width="100%" Filter="Contains"></telerik:RadComboBox>
        </td>
    </tr>
    <tr class="Table_RowC">
        <td style="width: 150px">راننده:</td>
        <td>
            <telerik:RadComboBox runat="server" ID="cmbBusDriver" Width="100%" Filter="Contains"></telerik:RadComboBox>
        </td>
    </tr>
    <tr class="Table_RowB">
