...
{
    public partial class JBusPassingStationTicketReportControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport(int BusNumebr = 0, DateTime? StartEventDate = null, DateTime? EndEventDate = null, int Zone = 0, int Fleet = 0, int Line = 0)
        {
            ...
            jGridView.SQL = @"SELECT abst.Code
                                ,af.Name FleetName
	                            ,az.Name ZoneName
	                            ,ab.LastLineNumber
                                ,ab.[BusNumber]
                            ...
                            left join AUTFleet af on af.Code = ab.FleetCode where " + WhereStr;
