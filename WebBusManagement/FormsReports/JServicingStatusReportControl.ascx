<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JServicingStatusReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JServicingStatusReportControl" %>
...
<div class="BigTitle">گزارش وضعیت سرویس دهی</div>
