<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JLinePeriodPaymentReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JLinePeriodPaymentReportControl" %>
...
<div class="BigTitle">گزارش پرداختی خطوط در دوره های زمانی</div>
...
<table style="width: 100%; height: auto; margin-top: 15px">
    <tr>
        <td style="width: 100%; height: auto; overflow: auto;text-align:right">
            <%=GetSumStr %>
        </td>
    </tr>
    <tr>
