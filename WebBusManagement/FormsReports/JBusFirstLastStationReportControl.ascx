<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusFirstLastStationReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusFirstLastStationReportControl" %>
...
<div class="BigTitle">گزارش ایستگاه های ابتدا و انتهای خط اتوبوس ها</div>
