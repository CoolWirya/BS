<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusServiceReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusServiceReportControl" %>
...
<div class="BigTitle">گزارش سرویس های اتوبوس ها</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowB">
       ...
       <tr class="Table_RowB">
        ...
        <td>
            <telerik:RadComboBox runat="server" ID="CmbFromConsole" Width="100%">
                 <Items>
                    <telerik:RadComboBoxItem Value="2" Text="همه" Selected="true" />
                    <telerik:RadComboBoxItem Value="1" Text="دستی"/>
                    <telerik:RadComboBoxItem Value="0" Text="اتوماتیک" />
                </Items>
