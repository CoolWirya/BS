<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusConsoleAndPortalTransactionReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusConsoleAndPortalTransactionReportControl" %>
...
<div class="BigTitle">گزارش مقایسه پرینت کنسول و پرتال</div>
