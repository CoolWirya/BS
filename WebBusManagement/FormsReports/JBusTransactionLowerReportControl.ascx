<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusTransactionLowerReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusTransactionLowerReportControl" %>
...
<div class="BigTitle">گزارش کسر تراکنش اتوبوس</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">تعداد تراکنش کمتر از:</td>
        <td>
            <telerik:RadTextBox runat="server" ID="txtTransactionCount" Width="96%" Text="600" InputType="Number"></telerik:RadTextBox>
        </td>
    </tr>
    <tr class="Table_RowB">
        <td style="width: 150px">به ازای هر:</td>
        <td>
            <telerik:RadComboBox runat="server" ID="cmbDayOrMont" Width="100%" Filter="Contains">
                <Items>
                    <telerik:RadComboBoxItem Value="0" Text="روز" Selected="true" />
                    <telerik:RadComboBoxItem Value="1" Text="ماه" />
                </Items>
            </telerik:RadComboBox>
        </td>
    </tr>
    ...
    <tr class="Table_RowB">
        ...
        <td>
            <telerik:RadComboBox runat="server" ID="cmbMount" Width="100%" Filter="Contains">
                <Items>
                    <telerik:RadComboBoxItem Value="01" Text="فروردین" Selected="true" />
                    <telerik:RadComboBoxItem Value="02" Text="اردیبهشت" />
                    <telerik:RadComboBoxItem Value="03" Text="خرداد" />
                    <telerik:RadComboBoxItem Value="04" Text="تیر" />
                    <telerik:RadComboBoxItem Value="05" Text="مرداد" />
                    <telerik:RadComboBoxItem Value="06" Text="شهریور" />
                    <telerik:RadComboBoxItem Value="07" Text="مهر" />
                    <telerik:RadComboBoxItem Value="08" Text="آبان" />
                    <telerik:RadComboBoxItem Value="09" Text="آذر" />
