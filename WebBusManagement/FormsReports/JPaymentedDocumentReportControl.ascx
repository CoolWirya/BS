<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JPaymentedDocumentReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JPaymentedDocumentReportControl" %>
...
<div class="BigTitle">گزارش وضعیت پرداختی اسناد</div>
