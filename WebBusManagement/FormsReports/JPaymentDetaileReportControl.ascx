<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JPaymentDetaileReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JPaymentDetaileReportControl" %>
...
<div class="BigTitle">گزارش جزئیات پرداختی ها</div>
