<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JLineSpeedAverageReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JLineSpeedAverageReportControl" %>
...
<div class="BigTitle">گزارش متوسط سرعت خطوط</div>
