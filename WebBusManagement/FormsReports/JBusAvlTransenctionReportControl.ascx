...
<table style="width: 500px">
    ...
    <tr class="Table_RowB">
        ...
        <td style="direction: ltr">
            ...
            :
                    <telerik:RadTextBox runat="server" ID="txtStartTimaSecond" Width="40px" MaxLength="2" EmptyMessage="ثانیه"></telerik:RadTextBox>
            <asp:RangeValidator ID="RangeValidator5" runat="server" ErrorMessage="00 تا 59" ControlToValidate="txtStartTimaSecond" MinimumValue="00"
                MaximumValue="59" ValidationGroup="Report" Display="Dynamic"></asp:RangeValidator>
        </td>
    </tr>
    <tr class="Table_RowC">
