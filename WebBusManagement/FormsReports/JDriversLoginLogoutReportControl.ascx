<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDriversLoginLogoutReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JDriversLoginLogoutReportControl" %>
...
<div class="BigTitle">گزارش ورود و خروج راننده</div>
