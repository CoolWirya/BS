<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JOvertimeTariffReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JOvertimeTariffReportControl" %>
...
<div class="BigTitle">گزارش تعرفه اضافه کاری</div>
