<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JComparativeServiceReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JComparativeServiceReportControl" %>
...
<div class="BigTitle">گزارش مقایسه ای سرویس ها</div>
