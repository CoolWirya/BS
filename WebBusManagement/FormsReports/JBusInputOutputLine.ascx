<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusInputOutputLine.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusInputOutputLine" %>
...
<div class="BigTitle">گزارش ورود و خروج اتوبوس از خط</div>
