<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusNotWorkInHokmeKarReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusNotWorkInHokmeKarReportControl" %>
...
<div class="BigTitle">گزارش اتوبوس هایی که طبق حکم کار ، کار نکرده اند</div>
