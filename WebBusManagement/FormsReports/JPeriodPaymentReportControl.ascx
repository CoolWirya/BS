<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JPeriodPaymentReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JPeriodPaymentReportControl" %>
...
<div class="BigTitle">گزارش پرداختی ها در دوره های زمانی</div>
