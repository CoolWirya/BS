<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusPassingStationTicketReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusPassingStationTicketReportControl" %>
...
<div class="BigTitle">گزارش تعداد بلیط اتوبوس در هر ایستگاه</div>
