<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JOwnerPaymentReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JOwnerPaymentReportControl" %>
...
<div class="BigTitle">گزارش مالی مالک</div>
