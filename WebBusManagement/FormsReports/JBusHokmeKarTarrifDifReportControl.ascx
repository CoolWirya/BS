<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusHokmeKarTarrifDifReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JBusHokmeKarTarrifDifReportControl" %>
...
<div class="BigTitle">گزارش اختلاف تعرفه و کارکرد</div>
