...
{
    public partial class JOwnerPaymentReportControl : System.Web.UI.UserControl
    {
        ...
        {
           WebControllers.MainControls.Grid.JGridView jGridView = RadGridReport; //("WebBusReports_JOwnerPaymentReportControl");
            jGridView.ClassName = "WebBusReports_JBusReports_GetReport_JOwnerPaymentReportControl"+OwnerCode.ToString()+ "_" +BusNumebr.ToString()+ "_" +(StartEventDate != null ? StartEventDate.Value.ToShortDateString() : "")+ "_" + (EndEventDate != null ? EndEventDate.Value.ToShortDateString() : "")+ "_" +DocumentCode.ToString();
            jGridView.SQL = BusManagment.Documents.JAUTDocumentReport.GetDocumentOwnerPaymentWebQuery(OwnerCode, BusNumebr, StartEventDate, EndEventDate,DocumentCode);
            jGridView.SQLType = (int)WebControllers.MainControls.Grid.SQLTypeEnum.Query;
            jGridView.PageSize = 50;
            jGridView.HiddenColumns = "Code";
            jGridView.Title = "JOwnerPaymentReportControl";
