<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JTariffServiceConflictReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JTariffServiceConflictReportControl" %>
...
<div class="BigTitle">گزارش مغایرت سرویس و تعرفه</div>
