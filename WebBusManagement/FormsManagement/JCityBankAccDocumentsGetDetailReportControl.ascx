<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JCityBankAccDocumentsGetDetailReportControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JCityBankAccDocumentsGetDetailReportControl" %>
