<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBazrasServiceUpdateControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JBazrasServiceUpdateControl" %>
...
<div class="BigTitle">ثبت سرویس توسط بازرس</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowC">
        <td style="width: 150px">بازرس:</td>
        <td>
            <uc1:JSearchPersonControl runat="server" id="JSearchBazrasPersonControl1" />
        </td>
    </tr>
    <tr class="Table_RowB">
    ...
    <tr class="Table_RowC">
        <td style="width: 150px">ساعت کارت:</td>
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">ساعت حرکت:</td>
        <td style="direction: ltr">
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">پردازش مجدد سرویسها:</td>
        <td>
            <telerik:RadComboBox runat="server" ID="cmbProcessAgain" Width="100%" Filter="Contains"></telerik:RadComboBox>
        </td>
    </tr>
</table>
