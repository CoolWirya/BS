<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JLinePathMap.ascx.cs" Inherits="WebBusManagement.FormsManagement.JLinePathMap" %>
...
<div style="width: 100%; height: 100%; z-index: 5999;">
...
<div id="Mnu_ControlPanel" class="trasparentBackground" style="width: 20%; height: 100%; position: absolute; top: 0px; right: 0px; z-index: 5999; color: white; display: block">
