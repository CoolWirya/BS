<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JTarrifEmptyPrintUpdateControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JTarrifEmptyPrintUpdateControl" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<%@ Register Src="~/WebControllers/MainControls/Date/JDateControl.ascx" TagPrefix="uc1" TagName="JDateControl" %>

<div class="BigTitle">ثبت تعرفه خام</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowC">
        <td style="width: 150px">تعداد تعرفه مورد نیاز:</td>
        <td>
            <telerik:RadTextBox runat="server" ID="txtNumOfEmptyTarrif" Width="50px" MaxLength="5"></telerik:RadTextBox>
        </td>
    </tr>
</table>
