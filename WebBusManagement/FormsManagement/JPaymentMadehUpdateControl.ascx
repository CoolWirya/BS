<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JPaymentMadehUpdateControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JPaymentMadehUpdateControl" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<div class="BigTitle">ثبت سندهای مانده حساب ها</div>
<table style="width: 550px">
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">شرح سند:</td>
        <td>
            <telerik:RadTextBox runat="server" ID="txtDocumentDescription" Width="96%" Enabled="true"></telerik:RadTextBox>
        </td>
    </tr>
</table>
