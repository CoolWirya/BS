<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDocumentsGetDetailReportControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JDocumentsGetDetailReportControl" %>
