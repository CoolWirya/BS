<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSendLineUpdateControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JBusSendLineUpdateControl" %>
...
<div class="BigTitle">ارسال اطلاعات خطوط به کنسول</div>
...
<%--                 AutoPostBack="true"
    ...
    <tr class="Table_RowC">
        <td style="width: 150px">ارسال همه خطوط:</td>
        <td>
