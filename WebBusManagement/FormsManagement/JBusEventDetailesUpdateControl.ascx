<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusEventDetailesUpdateControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JBusEventDetailesUpdateControl" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<div class="BigTitle">جزئیات وقایع</div>
<table style="width: 500px">
    ...
    <tr class="Table_RowB">
        <td style="width: 150px">نام جزئیات واقعه:</td>
        <td>
