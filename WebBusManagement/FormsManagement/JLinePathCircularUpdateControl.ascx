<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JLinePathCircularUpdateControl.ascx.cs" Inherits="WebBusManagement.FormsManagement.JLinePathCircularUpdateControl" %>
...
<div class="BigTitle">مسیر گردشی خط</div>
