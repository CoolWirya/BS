<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JProjectsUpdateControl.ascx.cs" Inherits="AndroidWebManagement.Forms.JProjectsUpdateControl" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<div class="BigTitle">پروژه ها</div>
<table style="width: 500px">
    <tr class="Table_RowB">
        <td style="width: 150px">عنوان پروژه:</td>
        <td>
