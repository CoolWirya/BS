<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JAboutUsTextAndPicUpdateControl.ascx.cs" Inherits="AndroidWebManagement.Forms.JAboutUsTextAndPicUpdateControl" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<div class="BigTitle">درباره ما</div>
<table style="width: 500px">
    <tr class="Table_RowC">
        <td style="width: 150px">متن درباره ما:</td>
        <td>
