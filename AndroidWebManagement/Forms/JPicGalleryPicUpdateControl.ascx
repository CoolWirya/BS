<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JPicGalleryPicUpdateControl.ascx.cs" Inherits="AndroidWebManagement.Forms.JPicGalleryPicUpdateControl" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<div class="BigTitle">عکس های گالری تصاویر</div>
<table style="width: 500px">
    <tr class="Table_RowB">
        <td style="width: 150px">دسته بندی:</td>
        <td>
           <telerik:RadComboBox runat="server" ID="cmbPicCategory" Width="100%" Filter="Contains"></telerik:RadComboBox>
        </td>
    </tr>
    <tr class="Table_RowB">
