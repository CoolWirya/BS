<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JSendMessageToAllUpdateControl.ascx.cs" Inherits="AndroidWebManagement.Forms.JSendMessageToAllUpdateControl" %>
...
<div class="BigTitle">ارسال پیام گروهی</div>
