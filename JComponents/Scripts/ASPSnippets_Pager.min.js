function ASPSnippetsPager(a, b) {
	...
	if (h > 1)
		...
		a.html("<br /><br /><span  page = \"1\" class=\"page pageInfo\"> نمایش رکوردهای <b>1</b> تا <b>" + b.RecordCount + "</b> از مجموع <b>" + b.RecordCount + "</b> رکورد </span>" + "<span style=\"background-color:white;border:none;color:black;width:150px;text-align:left;\">تعداد رکورد در صفحه:</span>");
	try {
		a[0].disabled = false
	}
	catch (m) { }
