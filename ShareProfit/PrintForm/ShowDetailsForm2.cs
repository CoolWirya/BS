...
{
    public partial class JShowDetailsForm2 : JBaseForm
    {
        public JShowDetailsForm2(int SheetNo, int PCode, int CourseCode)
        {
            InitializeComponent();
        ...
        public JShowDetailsForm2(int pAZ, int pEla, int CourseCode, bool pStockNo)
        {
            InitializeComponent();
            JPayment payment = new JPayment();
