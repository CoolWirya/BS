<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JLinesTransactionAndIncomeReportControl.ascx.cs" Inherits="WebBusManagement.FormsReports.JLinesTransactionAndIncomeReportControl" %>
...
<div class="BigTitle">گزارش تراکنش و درآمد خطوط</div>
