...
namespace WebBusManagement.FormsReports
{
    public partial class JDriverPerformanceReportControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport(int DriverCode = 0,int ZoneCode = 0, int LineNumber = 0, int BusNumebr = 0, int DayType = 0, DateTime? StartEventDate = null, DateTime? EndEventDate = null, int OwnerCode = 0, bool CalcService = false)
        {
            ...
            jGridView.SQL = BusManagment.Driver.JDriverseLogs.GetWebDriverPerformanceReportQuery(DriverCode, ZoneCode, LineNumber, BusNumebr, DayType, StartEventDate, EndEventDate, OwnerCode, CalcService);
        ...
        {
            GetReport(((WebControllers.MainControls.JSearchPersonControl)JSearchPersonControlDriver).PersonCode, Convert.ToInt32(cmbZone.SelectedValue), Convert.ToInt32(cmbLine.SelectedValue), Convert.ToInt32(cmbBus.SelectedValue),
