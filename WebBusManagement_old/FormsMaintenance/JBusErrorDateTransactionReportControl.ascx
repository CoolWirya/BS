<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusErrorDateTransactionReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusErrorDateTransactionReportControl" %>
...
<div class="BigTitle">گزارش خطای تاریخ</div>
