<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSummaryPerformanceReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusSummaryPerformanceReportControl" %>
...
<div class="BigTitle">گزارش خلاصه کارکرد اتوبوس</div>
