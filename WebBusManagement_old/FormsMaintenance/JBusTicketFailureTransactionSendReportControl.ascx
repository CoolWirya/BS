<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusTicketFailureTransactionSendReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusTicketFailureTransactionSendReportControl" %>
