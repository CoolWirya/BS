<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusTicketFailureBusNumberReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusTicketFailureBusNumberReportControl" %>
...
<div class="BigTitle">گزارش شماره اتوبوس های نامعتبر در تراکنش های بلیط</div>
