<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSummaryTransactionReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusSummaryTransactionReportControl" %>
...
<div class="BigTitle">گزارش خلاصه تراکنش های انجام شده یک اتوبوس</div>
