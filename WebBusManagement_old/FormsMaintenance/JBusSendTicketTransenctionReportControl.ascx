<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSendTicketTransenctionReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusSendTicketTransenctionReportControl" %>
...
<div class="BigTitle">گزارش ارسال تراکنش بلیط اتوبوس ها</div>
