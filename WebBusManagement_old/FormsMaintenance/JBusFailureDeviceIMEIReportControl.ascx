<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusFailureDeviceIMEIReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusFailureDeviceIMEIReportControl" %>
...
<div class="BigTitle">گزارش اختلاف بین IMEI ثبت شده برای اتوبوس با اطلاعات رسیده از کنسول</div>
