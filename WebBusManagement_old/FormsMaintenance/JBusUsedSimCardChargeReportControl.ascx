<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusUsedSimCardChargeReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusUsedSimCardChargeReport" %>
...
<div class="BigTitle">گزارش مصرف شارژ سیم کارت اتوبوس ها</div>
