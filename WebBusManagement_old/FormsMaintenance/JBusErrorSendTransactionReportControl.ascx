<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusErrorSendTransactionReportControl.ascx.cs" Inherits="WebBusManagement.FormsMaintenance.JBusErrorSendTransactionReportControl" %>
...
<div class="BigTitle">گزارش خطای ارسال</div>
