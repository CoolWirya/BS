<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JPermissionSetUserControl.ascx.cs" Inherits="WebBaseDefine.Forms.JPermissionSetUserControl" %>
...
<div class="FormContent" style="margin-bottom:40px;">
	...
	<table>
		...
		<tr>
			<td>
				<table>
					...
					<tr>
						<td>
							<asp:ListBox runat="server" ID="DefineClassListBox" Height="285px" Width="400px" AutoPostBack="True" OnSelectedIndexChanged="DefineClassListBox_SelectedIndexChanged" />
						</td>
					</tr>
				</table>
			</td>
			<td valign="top">
				<table>
					...
					<tr>
						<td>
							<asp:ListBox runat="server" ID="ObjectListBox" Height="267px" Width="250px" AutoPostBack="True" SelectionMode="Multiple" OnSelectedIndexChanged="ObjectListBox_SelectedIndexChanged" />
						</td>
					</tr>
					<tr>
						<td>
			...
			<td valign="top">
				<table>
					...
					<tr>
						<td>
							<asp:ListBox runat="server" ID="DecissionsListBox" Height="262px" Width="250px" />
						</td>
					</tr>
					<tr>
						<td>
		...
		<tr>
			<td colspan="3">
				<asp:ListBox runat="server" ID="PermissionUserListBox" Height="130px" Width="929px" SelectionMode="Multiple" />
			</td>
		</tr>
	</table>
</div>
