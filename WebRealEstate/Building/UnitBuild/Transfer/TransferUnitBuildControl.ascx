<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransferUnitBuildControl.ascx.cs" Inherits="WebRealEstate.Building.UnitBuild.Transfer.TransferUnitBuildControl" %>
...
<table>
                ...
                <telerik:RadPageView runat="server" ID="rpvD1">
                    <table>
                        <tr><td>
                            ...
                            <td>
                                <uc2:JDateControl runat="server" id="JDateDate" />
                            </td>
                            <td>
                                شماره :
                            </td>
                            ...
                            <td>
                                <asp:TextBox ID="txtPriceHaghEnteghal" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkBoxCusSign" runat="server"  Text="امضا فروشنده"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                 <asp:TextBox ID="NumGhete" runat="server"></asp:TextBox>
                             </td>
                            <td>
                                مساحت :
                             </td>
    ...
    <tr>
        <td>توضیحات :</td>
        <td>
            <asp:TextBox ID="txtDsc" runat="server"></asp:TextBox></td>
        <td></td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        <td>
            <asp:Button ID="btnAcc" runat="server" Text="تایید" /></td>
