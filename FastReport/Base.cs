...
namespace FastReport
{
  ...
  public abstract class Base : Component, IFRSerializable
  {
    ...
    /// <summary>
    /// Used to extract "TotalPages#" and "Page#" macros in the preview mode.
    /// </summary>
    /// <param name="pageIndex">Index of object's page.</param>
    /// <param name="totalPages">Total number of pages in a report.</param>
    /// <remarks>
    ...
    /// </remarks>
    public virtual void ExtractMacros(int pageIndex, int totalPages)
    {
    }
    #endregion
    ...
    public Base()
    {
      ...
      SetFlags(Flags.CanMove | Flags.CanResize | Flags.CanDelete | Flags.CanEdit | Flags.CanChangeOrder |
       Flags.CanChangeParent | Flags.CanCopy | Flags.CanDraw, true);
    }
  }
}