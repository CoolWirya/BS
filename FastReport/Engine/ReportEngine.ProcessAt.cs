...
namespace FastReport.Engine
{
  ...
  internal class ProcessInfo
  {
    ...
    public XmlItem XmlItem;

    public bool Process(EngineState state)
    {
      ProcessAt processAt = TextObject.ProcessAt;
      if ((processAt == ProcessAt.ReportFinished && state == EngineState.ReportFinished) ||
        ...
        (processAt == ProcessAt.DataFinished && state == EngineState.BlockFinished))
      {
