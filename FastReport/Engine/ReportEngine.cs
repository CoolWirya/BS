...
namespace FastReport.Engine
{
  ...
  public partial class ReportEngine
  {
    ...
    private void PrepareToFirstPass(bool append)
    {
      ...
      FFirstPassPage = PreparedPages.CurPage;
      FFirstPassPosition = PreparedPages.CurPosition;
    ...
    private void ClearFirstPass()
    {
      ...
      FObjectsToProcess.Clear();
      PreparedPages.ClearFirstPass(FFirstPassPage, FFirstPassPosition);
      PreparedPages.CurPage = FFirstPassPage;
    }
