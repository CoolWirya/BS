...
namespace FastReport.Engine
{
  public partial class ReportEngine
  {
    ...
    internal void AddToPreparedPages(BandBase band)
    {
      ...
      // (that may happen when we render a subreport, or append a report to another one).
      bool bandAdded = true;
    ...
    private void ShowBandToPreparedPages(BandBase band, bool getData)
    {
      ...
      if (band.StartNewPage && band.FlagUseStartNewPage && band.RowNo != 1 && !band.Repeated)
        EndColumn();
