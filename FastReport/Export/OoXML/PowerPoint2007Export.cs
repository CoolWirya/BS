...
namespace FastReport.Export.OoXML
{
    ...
    internal class PptShape : OoXMLBase
    {
        ...
        private void Export_Fills(StreamWriter Out)
        {
            ...
            {
                throw new Exception("Unkbown fill");
            }
    ...
    internal class OoPptSlide : OoSlideBase
    {
        ...
        private void AddBandObject(StreamWriter outstream, BandBase band)
        {
            if (band.HasBorder || band.HasFill ) using (TextObject newObj = new TextObject())
            {
                ...
                newObj.Text = "";
                AddTextObject(outstream, newObj);
            }
        }
        ...
        private void AddTextObject(StreamWriter outstream, TextObject obj)
        {
            PptShape shape = new PptShape( id + 1, NO_RELATION, "TextBox " + id, obj, FPPT_export );
        ...
        {
            FPicCount++; // Increase picture counter
            ...
            string ImageFileName = FPPT_export.TempFolder + "/" + FileName + FPicCount.ToString() + "." + file_extension;
            ...
            return new PptShape(id + 1, rId, FileName + FPicCount.ToString() + "." + file_extension, obj, FPPT_export);
        }
        ...
        private void AddPictureObject(StreamWriter Out, int rId, ReportComponentBase obj, string FileName)
        {
            ...
            Out.WriteLine("<p:pic>");
            shape.Export_nvPicPr(Out, FPicCount);
            shape.Export_blipFill(Out);
            shape.Export_spPr(Out, "rect");
            Out.WriteLine("</p:pic>");
