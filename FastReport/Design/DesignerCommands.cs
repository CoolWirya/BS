 ...
 !Restrictions.DontCreatePage && ActiveReport != null;
  ...
  public class DeletePageCommand : DesignerCommand
  {
    ...
    public override void Invoke()
    {
      ...
      {
        Designer.Lock();
        ActiveReport.Pages.Remove(ActiveReportTab.ActivePage);
        SetModified("DeletePage");
        Designer.Unlock();
      }
    }
  ...
  /// <summary>
  /// Represents the commands under the "Data" menu.
  /// </summary>
  public class DataCommand : DesignerCommand
  {
    /// <inheritdoc/>
    protected override bool GetEnabled()
    {
    ...
    /// <summary>
    /// Invokes the "Data|Choose Report Data..." command.
    /// </summary>
    /// <param name="sender">Sender.</param>
    /// <param name="e">Event args.</param>
    public void InvokeReportData(object sender, EventArgs e)
    {
    ...
    /// <summary>
    /// Invokes the "Data|Add Data Source..." command.
    /// </summary>
    /// <param name="sender">Sender.</param>
    /// <param name="e">Event args.</param>
    public void InvokeAddDataSource(object sender, EventArgs e)
    {
#if (!Basic)
    ...
    internal DataCommand(Designer designer)
      : base(designer)
    {
    }
  }
