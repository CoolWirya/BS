...
namespace FastReport
{
  ...
  public abstract class ReportComponentBase : ComponentBase
  {
    ...
    public string Style
    {
      ...
      set
      {
        ...
        if (Report != null)
        {
          ...
          int index = styles.IndexOf(value);
          if (index != -1)
    ...
    /// </summary>
    /// <remarks>
    /// Style with this name must exists in the <see cref="Report.Styles"/> collection.
    /// </remarks>
    [Editor(typeof(StyleEditor), typeof(UITypeEditor))]
    [Category("Appearance")]
    ...
    /// <summary>
    /// Gets or sets a value that determines whether properties of even style to use.
    /// </summary>
    /// <remarks>
    /// Usually you will need only fill property of the even style to be applied. If you want to 
