...
namespace FastReport.Preview
{
  internal class PreparedPage : IDisposable
  {
    ...
    private void PostProcessPageObjects(Base obj, int pageIndex, int totalPages)
    {
      obj.ExtractMacros(pageIndex, totalPages);
      if (obj is BandBase)
      ...
      {
        PostProcessPageObjects(c, pageIndex, totalPages);
      }
    }
    ...
    public ReportPage GetPage(int pageIndex, int totalPages)
    {
      ...
      PostProcessPageObjects(page, pageIndex, totalPages);
