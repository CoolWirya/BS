        ...
        void btnExport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (TotalPages > 0)
            {
                ...
                if (exported)
                {
                    ...
                    this.Page.Response.Redirect(this.Page.Request.Url.AbsolutePath + "?" + FExportPrefix + "=" + guid);
...
//                this.Page.Response.Write("<html><script>window.open('http://fast-report.com', '_blank');</script></html>");
//                this.Page.Response.End();
            }
        }
