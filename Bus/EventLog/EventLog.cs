...
");
        ...
        public static bool SaveDriverLoginLogout(string eventType, string eventDatetime, uint busNumber, long driverSerialCard, JDataBase Db = null)
        {
            ...
            try
            {
                ...
                {
                    Db.setQuery(@"select top 1 * from  " + JMainFrame.Server01 + @"erp_tabrizbus.[dbo].[AUTDriversLoginLogout] 
                    ...
                    {
                        Db.setQuery(@"UPDATE " + JMainFrame.Server01 + @"erp_tabrizbus.[dbo].[AUTDriversLoginLogout] 
                    ...
                    {
                        Db.setQuery(@"INSERT INTO " + JMainFrame.Server01 + @"erp_tabrizbus.[dbo].[AUTDriversLoginLogout]
                                        ([Date]
                                        ,[BusNumber]
                                        ,[DriverCardSerial]
                                        ,[DriverPersonCode]
            ...
            try
            {
                ...
                if (Dt != null)
                {
                    if (Dt.Rows.Count > 0)
                    {
                        ...
                        {
                            Db.setQuery(@"
                            IF(EXISTS(SELECT * FROM " + JMainFrame.Server01 + @"erp_tabrizbus.[dbo].[AUTDriversLoginLogout] 
        ...
        public void SendMessage(ClassLibrary.JDataBase Db, ClassLibrary.JMySQLDataBase mysqlDB)
        {
            try
            {
                ...
                Db.setQuery(@"
                    ...
                    SELECT TOP 100 Code, BusNumber, MessageText INTO #Messagetemp FROM dbo.AutConsoleMessage WHERE Status = 0 ORDER BY InsertDate DESC
