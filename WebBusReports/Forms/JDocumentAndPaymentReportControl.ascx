<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDocumentAndPaymentReportControl.ascx.cs" Inherits="WebBusReports.Forms.JDocumentAndPaymentReportControl" %>
