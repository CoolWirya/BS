<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDriverStatisticalReportControl.ascx.cs" Inherits="WebBusReports.Forms.JDriverStatisticalReportControl" %>
