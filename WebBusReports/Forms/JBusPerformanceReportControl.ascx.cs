...
namespace WebBusReports.Forms
{
    public partial class JBusPerformanceReportControl : System.Web.UI.UserControl
    {
        ...
        public void GetReport(int ZoneCode = 0, int LineNumber = 0, int BusNumebr = 0, int DayType = 0, DateTime? StartEventDate = null, DateTime? EndEventDate = null, int OwnerCode = 0, bool CalcService = false)
        {
            ...
            jGridView.SQL = BusManagment.Bus.JBuses.GetWebBusPerformanceReportQuery(ZoneCode, LineNumber, BusNumebr, DayType, StartEventDate, EndEventDate, OwnerCode, CalcService);
