<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JDailyStatisticalReportControl.ascx.cs" Inherits="WebBusReports.Forms.JDailyStatisticalReportControl" %>
    ...
    <tr>
        <td style="width: 100%; height: auto; overflow: auto">
            <telerik:RadTabStrip runat="server" ID="RadTabStrip1"
                ...
                <Tabs>
                    <telerik:RadTab Text="تعداد تراکنش در روز">
                    </telerik:RadTab>
                    <telerik:RadTab Text="میزان درآمد در روز">
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
