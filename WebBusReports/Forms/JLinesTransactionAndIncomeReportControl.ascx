<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JLinesTransactionAndIncomeReportControl.ascx.cs" Inherits="WebBusReports.Forms.JLinesTransactionAndIncomeReportControl" %>
