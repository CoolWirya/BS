...
namespace Legal
{
    public class JFish : JLegal
    {
        ...
        public bool GetData(int pCode)
        {
            ...
            try
            {
                DB.setQuery("SELECT * FROM " + JTableNamesContracts.Fish + " WHERE Code=" + pCode.ToString());
                DB.Query_DataReader();
        ...
        public DataTable GetAllData(int pContractSubjectCode)
        {
            ...
            try
            {
                DB.setQuery("SELECT * FROM " + JTableNamesContracts.Fish + " WHERE ContractSubjectCode=" + pContractSubjectCode.ToString());
        ...
        public static DataTable GetAllData(int pContractSubjectCode, int type)
        {
            ...
            {
                if (type == 1)
                    DB.setQuery("SELECT A.Code,P.Code PersonCode,Name,PersonType FROM " + JTableNamesContracts.Fish + " A inner join clsAllPerson P on A.ExporterCode = P.Code WHERE ContractSubjectCode=" + pContractSubjectCode.ToString());
                else
                    DB.setQuery("SELECT A.Code,P.Code PersonCode,Name,PersonType FROM " + JTableNamesContracts.Fish+ " A inner join clsAllPerson P on A.ReceiverCode = P.Code WHERE ContractSubjectCode=" + pContractSubjectCode.ToString());
                return DB.Query_DataTable();
            }
            catch (Exception ex)
            {
