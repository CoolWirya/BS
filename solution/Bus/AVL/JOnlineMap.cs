    ...
    public class JOnlineMap
    {
        ...
        public static void UpdateBusLocation(int pBackTime, int lenTime)
        {
            ...
            try
            {
                db.setQuery(@"
update AUTBus set
		 	   --LastSimCardCharge = AT.SimCardChargeTrue,
	           ...
	           LastSpeed = AT.Speed,
	           --LastBatteryCharge = AT.BatteryCharge,
	           --LastGpsAntenna = AT.GpsAntenna,
	           --LastGsmAntenna = AT.GsmAntenna,
...
AT
ON AB.Code = AT.BusCode
 --where
 --AB.LastLongitude <> AT.Longitude
 --and
 --AB.LastLatitude <> AT.Latitude
 --and 
 --AB.LastDate <> AT.EventDate");
