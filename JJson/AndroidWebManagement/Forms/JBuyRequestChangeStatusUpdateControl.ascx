<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBuyRequestChangeStatusUpdateControl.ascx.cs" Inherits="AndroidWebManagement.Forms.JBuyRequestChangeStatusUpdateControl" %>
        ...
        <td>
            <telerik:RadComboBox runat="server" ID="cmbStatus" Width="100%">
                <Items>
                    ...
                    <telerik:RadComboBoxItem Value="-1" Text="کنسل شده"/>
                </Items>
            </telerik:RadComboBox>
        </td>
    </tr>
