<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JInstallStateSupplyDuctsReportControl.ascx.cs" Inherits="WebOilManagement.FormsReports.JInstallStateSupplyDuctsReportControl" %>
...
<p>
    رویت وضعیت نصب تجهیزات در مجاری عرضه</p>
<table>
    <tr class="Table_RowB">
        <td>منطقه :</td>
        <td>
