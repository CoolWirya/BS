<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JManagerPortalReportsControl.ascx.cs"
    Inherits="WebOilManagement.FormsReports.JManagerPortalReportsControl" %>
...
<div class="BigTitle" runat="server" id="divTitle"> </div>
