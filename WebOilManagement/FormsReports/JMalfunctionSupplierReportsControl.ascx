<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JMalfunctionSupplierReportsControl.ascx.cs"
    Inherits="WebOilManagement.FormsReports.JMalfunctionSupplierReportsControl" %>
...
<div class="BigTitle">گزارش هاي کل تیکت های ثبت شده </div>
<table style="width: 500px">
    ...
    <tr class="Table_RowC">
        <td>ناحیه:</td>
        <td>
            <telerik:RadComboBox runat="server" ID="cmbArea" Filter="Contains" OnSelectedIndexChanged="cmbArea_SelectedIndexChanged"></telerik:RadComboBox>
        </td>
    </tr>
    <tr class="Table_RowB">
        <td>پیمانکار:</td>
    ...
    <tr class="Table_RowB">
        ...
        <td>
            <telerik:RadComboBox runat="server" ID="cmbDontFixDefects" Enabled="false" Width="100%" OnSelectedIndexChanged="cmbDontFixDefects_SelectedIndexChanged"></telerik:RadComboBox>
        </td>
    </tr>
    <tr class="Table_RowB">
