<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JMalFunctionsTableDamagesReportsControl.ascx.cs"
    Inherits="WebOilManagement.FormsReports.JMalFunctionsTableDamagesReportsControl" %>
...
<div class="BigTitle">تعداد تیکت های ثبت شده به ازا نوع خرابی </div>
