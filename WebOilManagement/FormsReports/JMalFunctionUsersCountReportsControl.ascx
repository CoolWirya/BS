<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JMalFunctionUsersCountReportsControl.ascx.cs"
    Inherits="WebOilManagement.FormsReports.JMalFunctionUsersCountReportsControl" %>
