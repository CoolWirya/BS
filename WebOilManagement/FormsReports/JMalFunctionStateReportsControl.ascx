<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JMalFunctionStateReportsControl.ascx.cs"
    Inherits="WebOilManagement.FormsReports.JMalFunctionStateReportsControl" %>
...
<div class="BigTitle">تعداد تیکت های ثبت شده به وضعیت </div>
