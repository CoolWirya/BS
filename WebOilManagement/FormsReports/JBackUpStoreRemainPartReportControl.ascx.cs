...
{
    public partial class JBackUpStoreRemainPartReportControl : System.Web.UI.UserControl
    {
        ...
        private void GetReport(int AreaCode = 0, int OilZoneCode = 0, int Supplier = 0
                                , int TypeOfGoodcode = 0, DateTime? AsDate = null, DateTime? ToDate = null)
        {

            WebControllers.MainControls.Grid.JGridView jGridView = new WebControllers.MainControls.Grid.JGridView("BackUpStoreRemainPartReport");
            ...
            jGridView.Title = "JBackUpStoreRemainPartReportControl";
