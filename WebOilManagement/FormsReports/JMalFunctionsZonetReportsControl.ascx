<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JMalFunctionsZonetReportsControl.ascx.cs"
    Inherits="WebOilManagement.FormsReports.JMalFunctionsZonetReportsControl" %>
...
<div class="BigTitle">گزارش تیکت های ثبت شده در مناطق نفتی </div>
