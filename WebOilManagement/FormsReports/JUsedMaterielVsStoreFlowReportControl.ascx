<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JUsedMaterielVsStoreFlowReportControl.ascx.cs" Inherits="WebOilManagement.FormsReports.JUsedMaterielVsStoreFlowReportControl" %>
...
<p>
    گزارش گیري مقایسه ای بین مصارف تجهیزات و گردش انبار</p>
...
<table>
    ...
    <tr class="Table_RowC">
        <td>ناحیه :</td>
        <td>
            <telerik:RadComboBox runat="server" ID="cmbArea" AutoPostBack="true" Filter="Contains" ></telerik:RadComboBox>
        </td>
    </tr>
    <tr class="Table_RowB">
        <td>از تاریخ :</td>
