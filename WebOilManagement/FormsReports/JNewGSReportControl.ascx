<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JNewGSReportControl.ascx.cs"
    Inherits="WebOilManagement.FormsReports.JNewGSReportControl" %>
...
<div class="BigTitle">گزارش آمار جایگاه‌های جدیدالتاسیس</div>
