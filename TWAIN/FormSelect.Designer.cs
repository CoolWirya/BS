namespace TWAINCSScan
{
    partial class FormSelect
    {
        ...
        private void InitializeComponent()
        {
			...
			this.m_listboxSelect.SelectedIndexChanged += new System.EventHandler(this.m_listboxSelect_SelectedIndexChanged);
			this.m_listboxSelect.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.m_listboxSelect_MouseDoubleClick);
			// 
			// m_buttonOpen
			// 
