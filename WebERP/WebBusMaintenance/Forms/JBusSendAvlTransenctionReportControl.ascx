<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSendAvlTransenctionReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JBusSendAvlTransenctionReportControl" %>
