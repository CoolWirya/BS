<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusAvlFailureTransactionSendReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JBusAvlFailureTransactionSendReportControl" %>
