<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusErrorSendTransactionReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JBusErrorSendTransactionReportControl" %>
