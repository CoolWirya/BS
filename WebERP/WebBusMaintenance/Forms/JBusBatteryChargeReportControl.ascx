<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusBatteryChargeReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JBusBatteryChargeReportControl" %>
