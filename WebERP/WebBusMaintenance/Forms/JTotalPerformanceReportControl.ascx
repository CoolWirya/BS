<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JTotalPerformanceReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JTotalPerformanceReportControl" %>
