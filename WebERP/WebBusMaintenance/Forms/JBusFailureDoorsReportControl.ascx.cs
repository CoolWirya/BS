...
namespace WebBusMaintenance.Forms
{
    public partial class JBusFailureDoorsReportControl : System.Web.UI.UserControl
    {
        ...
        public static string GetReportQuery(DateTime? StartEventDate = null, DateTime? EndEventDate = null, TimeSpan? StartTime = null, TimeSpan? EndTime = null)
        {
            ...
            Query = @"SELECT top 100 percent MAX(at.Code) AS Code,at.FleetName,at.ZoneName,at.LineNumber,at.BusNumber,at.EventDate,
                        ...
                        WHERE 1=1 " + WhereStr + @"
                        GROUP BY at.FleetName,at.ZoneName,at.LineNumber,at.BusNumber,at.EventDate,at.ReaderId
