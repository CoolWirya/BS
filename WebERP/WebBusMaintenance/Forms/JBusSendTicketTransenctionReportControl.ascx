<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSendTicketTransenctionReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JBusSendTicketTransenctionReportControl" %>
