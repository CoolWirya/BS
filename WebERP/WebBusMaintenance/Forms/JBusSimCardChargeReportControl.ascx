<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusSimCardChargeReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JBusSimCardChargeReportControl" %>
