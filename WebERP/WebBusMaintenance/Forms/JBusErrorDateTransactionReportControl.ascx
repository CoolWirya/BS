<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JBusErrorDateTransactionReportControl.ascx.cs" Inherits="WebBusMaintenance.Forms.JBusErrorDateTransactionReportControl" %>
