<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JZonesStatisticalReportControl.ascx.cs" Inherits="WebBusReports.Forms.JZonesStatisticalReportControl" %>
    ...
    <tr>
        <td style="width: 100%; height: auto; overflow: auto">
            <telerik:RadTabStrip runat="server" ID="RadTabStrip1"
                ...
                <Tabs>
                    <telerik:RadTab Text="تعداد تراکنش مناطق">
                    </telerik:RadTab>
                    <telerik:RadTab Text="میزان درآمد مناطق">
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
